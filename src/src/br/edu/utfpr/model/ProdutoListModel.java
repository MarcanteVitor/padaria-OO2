...
public class ProdutoListModel extends AbstractTableModel{
    ...
    private String[] colunas = new String[] { "Id", "produto", "valor unitario", "quantidade", "valor total", "observacao"};
    ...
    public Object getValueAt(int row, int column) {
        ...
        switch (column) {
            ...
            case 3:
                return produto.getValor_producao_compra();
            case 4:
                return produto.isUso_consumo();
            case 5:
